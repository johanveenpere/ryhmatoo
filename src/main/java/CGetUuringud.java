//Algne kood võetud lehelt: https://saravanansubramanian.com/dicomqueryretrievecget/
...
public class CGetUuringud implements Serveriühendus {
    ...
    public String TõmbaUuringud(String pildiviit, String failiTee) {
        try {
            ...
            fileGetter getter = new fileGetter("dicomserver.co.uk", "dicomserver", 11112, "./uuringud/");
            new FindSOPClassSCU("www.dicomserver.co.uk", 104, "MEDCONNEC", "OURCLIENT", SOPClass.StudyRootQueryRetrieveInformationModelFind, identifier, getter);
...
class fileGetter extends IdentifierHandler{
    ...
    public void doSomethingWithIdentifier(AttributeList attributeListForFindResult) throws DicomException {
        ...
        try {
            ...
            System.out.println("Error during get operation" + e);
            e.printStackTrace(System.err);
        }
    }
}
